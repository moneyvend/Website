...
import supportStyle from './support-page.module.scss';
...
export default function SupportPage() {
    ...
    return (
        <section>
            <NavBar />
            <div className={supportStyle.holdAll}>
                <div className={supportStyle.holdHeader}>
                    <h2>Support Page</h2>
                    <p>Let us know how we may be of service to you</p>
                </div>
                <div className={supportStyle.holdFormAndText}>
                    <div className={supportStyle.holdForm}>
                        <Form>
                            ...
                            <Button className={supportStyle.butin} variant="primary" type="submit">
                                Submit
                            </Button>
                        </Form>
                    </div>
                    <div className={supportStyle.holdText}>
                        <p className={supportStyle.address}>
                            <BsFillTelephoneOutboundFill className={supportStyle.icon} />
                ...
                <div className={supportStyle.holdFQAll}>
                    <div className={supportStyle.holdFQ}>
